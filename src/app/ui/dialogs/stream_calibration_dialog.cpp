...
namespace calibmar {
  ...
  StreamCalibrationDialog::StreamCalibrationDialog(QWidget* parent) : QDialog(parent) {
    ...
    //cam_num 
    QLabel* cam_num_label = new QLabel(camera_groupbox);
    cam_num_label->setText("num of cameras");
    cam_num_label_ = new QSpinBox(this);
    cam_num_label_->setRange(0, 10);
    cam_num_label_->setSingleStep(1);
    cam_num_label_->setValue(0);
    ...
    formLayout_index->setWidget(1, QFormLayout::LabelRole, cam_num_label);
    formLayout_index->setWidget(1, QFormLayout::FieldRole, cam_num_label_);
    ...
    save_image_groupbox->setTitle("Import calibration result");
    ...
    connect(select_directory_button, &QPushButton::released, this, [this]() {
      directory_edit_->setText(QFileDialog::getExistingDirectory(this, "Select calibration result in air"));
    });
  ...
  StreamCalibrationDialog::Options StreamCalibrationDialog::GetOptions() {
    ...
    options.cam_num_label = cam_num_label_->value();
