...
namespace calibmar {
  ...
  CharucoBoardTargetOptionsWidget::CharucoBoardTargetOptionsWidget(QWidget* parent,bool is_system_calibration) : QWidget(parent) {
  ...
  void CharucoBoardTargetOptionsWidget::SetCharucoBoardTargetOptions(const CharucoBoardFeatureExtractor::Options& options) {
    ...
    frame_num_edit_->setValue(options.frame_num);
  ...
  CharucoBoardFeatureExtractor::Options CharucoBoardTargetOptionsWidget::CharucoBoardTargetOptions() {
    ...
    options.frame_num = frame_num_edit_->value();
