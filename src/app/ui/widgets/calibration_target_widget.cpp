...
namespace calibmar {
  ...
  CalibrationTargetOptionsWidget::CalibrationTargetOptionsWidget(QWidget* parent,bool is_system_calibration) : QGroupBox(parent) {
  ...
  CalibrationTargetOptionsWidget::Options CalibrationTargetOptionsWidget::CalibrationTargetOptions() {
    ...
    else if (target_type_combobox_->currentIndex() == 2) {
