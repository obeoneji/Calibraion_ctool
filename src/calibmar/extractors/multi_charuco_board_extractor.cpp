...
namespace calibmar {              
  ...
  MultiCharucoBoardFeatureExtractor::MultiCharucoBoardFeatureExtractor(const Options& options) : options_(options) {
    // generate 3D points for Charuco board
    uint32_t idx = 0;
    for (int board=0;board<options_.board_index;board++)
    {
    ...
    //   return points3D;
    // }
  FeatureExtractor::Status MultiCharucoBoardFeatureExtractor::Extract(Image& image, const Pixmap& pixmap) {
