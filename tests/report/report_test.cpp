...
//   BOOST_TEST(parameters.camera_parameters[0].size() == camera.params.size());
//   for (size_t i = 0; i < parameters.camera_parameters[0].size(); i++) {
//     BOOST_TEST(parameters.camera_parameters[0][i] == camera.params[i]);
//   }
